...
def create_world(multirobot=False):
    ...
    table = w.add_location("table", "kitchen", Pose(
        x=0.85, y=-0.5, z=0.0, qw=0.7071, qx=0.7071, qy=0.0, qz=0.0))
    ...
    counter = w.add_location("counter", "bathroom", Pose(
        x=-2.45, y=2.5, z=0.0, qw=0.634411, qx=0.0, qy=0.0, qz=0.7729959))

    # Add objects
    w.add_object("banana", table, pose=Pose(x=1.0, y=-0.5, z=0.0, qw=0.9238811, qx=0.0, qy=0.0, qz=0.3826797))
